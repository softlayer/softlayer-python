...
Or to install via source, download the source and change directory to your downloaded project root directory. Then run the following command to install this pagkage:
