...
class OrderingTests(testing.TestCase):
    ...
    def test_generate_order_template_quantity(self):
        result = self.ordering.generate_order_template(
            1234, [{'hostname': 'test1', 'domain': 'example.com'}, {'hostname': 'test2', 'domain': 'example.com'}],
            quantity=2)
        self.assertEqual(result, {'presetId': None,
                                  'hardware': [{'domain': 'example.com',
                                                'hostname': 'test1'},
    ...
    def test_generate_order_with_quantity(self):
        ...
        extras = {"hardware": [{"hostname": "gateway01", "domain": "example.com"},
                               {"hostname": "gateway02", "domain": "example.com"}]}
        complex_type = 'My_Type'
        expected_order = {'orderContainers': [
            {'complexType': 'My_Type',
             "hardware": [{"hostname": "gateway01", "domain": "example.com"},
                          {"hostname": "gateway02", "domain": "example.com"}],
             'location': 1854895,
             'packageId': 1234,
             'prices': [{'id': 1111}, {'id': 2222}],
        ...
        order = self.ordering.generate_order(pkg, 'DALLAS13', items, complex_type=complex_type, extras=extras,
                                             quantity=quantity)
    ...
    def test_place_order_with_quantity(self):
        ...
        preset_keyname = 'PRESET'
        complex_type = 'Complex_Type'
        extras = {"server": [{"hostname": "test01", "domain": "example.com"},
