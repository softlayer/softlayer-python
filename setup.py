...
cli_entry_points = [
    ...
    'messaging = SoftLayer.CLI.messaging',
    # 'messaging:accounts-list = SoftLayer.CLI.messaging.accounts_list:cli',
    # 'messaging:endpoints-list = SoftLayer.CLI.messaging.endpoints_list:cli',
    # 'messaging:accounts-list = SoftLayer.CLI.messaging.accounts_list:cli',
    # 'messaging:ping = SoftLayer.CLI.messaging.ping:cli',
    # 'messaging:queue-add = SoftLayer.CLI.messaging.queue_add:cli',
    # 'messaging:queue-detail = SoftLayer.CLI.messaging.queue_detail:cli',
    # 'messaging:queue-edit = SoftLayer.CLI.messaging.queue_edit:cli',
    # 'messaging:queue-list = SoftLayer.CLI.messaging.queue_list:cli',
    # 'messaging:queue-pop = SoftLayer.CLI.messaging.queue_pop:cli',
    # 'messaging:queue-push = SoftLayer.CLI.messaging.queue_push:cli',
    # 'messaging:queue-remove = SoftLayer.CLI.messaging.queue_remove:cli',
    # 'messaging:topic-add = SoftLayer.CLI.messaging.topic_add:cli',
    # 'messaging:topic-detail = SoftLayer.CLI.messaging.topic_detail:cli',
    # 'messaging:topic-list = SoftLayer.CLI.messaging.topic_list:cli',
    # 'messaging:topic-push = SoftLayer.CLI.messaging.topic_push:cli',
    # 'messaging:topic-remove = SoftLayer.CLI.messaging.topic_remove:cli',
    # 'messaging:topic-subscribe = SoftLayer.CLI.messaging.topic_subscribe:cli',
    # 'messaging:topic-unsubscribe = SoftLayer.CLI.messaging.topic_unsubscribe:cli',
    ...
    # 'server:power-cycle = SoftLayer.CLI.server.power_cycle:cli',
    # 'server:power-off = SoftLayer.CLI.server.power_off:cli',
    # 'server:power-on = SoftLayer.CLI.server.power_on:cli',
    # 'server:reboot = SoftLayer.CLI.server.reboot:cli',
