...
ALL_ROUTES = [
    ...
    ('virtual:power_off', 'SoftLayer.CLI.virt.power:power_off'),
    ('virtual:power_on', 'SoftLayer.CLI.virt.power:power_on'),
    ...
    ('hardware:nic-edit', 'SoftLayer.CLI.hardware.nic_edit:cli'),
