...
;(function($) {
  $.fn.estimatedTime = function(options) {
    ...
    var plugin   = this;
        el       = $(this);
        defaults = {
          estimateOutput:    ".eta", // was readingTimeTarget
          wordCount:         null,
          wordsPerMinute:    255,
          rounding:          true,
          lessThanOneMinute: "",
    ...
    var estimateOutput    = plugin.settings.estimateOutput;
	  ...
	  if(rounding === true) {
	    var estimatedTimeInMinutes = Math.round(totalTimeInSeconds / 60); } 
          else {
            var estimatedTimeInMinutes = Math.floor(totalTimeInSeconds / 60);
	  }
